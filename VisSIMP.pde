...
void mousePressed()
{
  ...
  {
    if (programMenu == null || !programMenu.containsMouse(false))
    {
      programMenu = createMenu(mouseX, mouseY);
    }
  } else if (mouseButton == LEFT)
  {
    if (programMenu!=null && programMenu.containsMouse(true))
      programMenu=null;
    else
    { 
      programMenu=null;
